...
(function (global, factory) {
  ...
  var Utils__Utils = {
    ...
    _SubmitSelector: 'input[type="submit"], button:submit, [data-validate-form]'
  };
  ...
  var Defaults = {
    ...
    errorsWrapper: '<ul class="parsley-errors-list hide"></ul>',
  ...
  Parsley.addMessages('en', {
    defaultMessage: "<div class=\"alert alert-danger\">This seems to be invalid.</div>",
    type: {
      email: "<div class=\"alert alert-danger\">This should be a valid email.</div>",
      url: "<div class=\"alert alert-danger\">This should be a valid url.</div>",
      number: "<div class=\"alert alert-danger\">This should be a valid number.</div>",
      integer: "<div class=\"alert alert-danger\">This should be a valid integer.</div>",
      digits: "<div class=\"alert alert-danger\">This should be digits.</div>",
      alphanum: "<div class=\"alert alert-danger\">This should be alphanumeric.</div>"
    },
    notblank: "<div class=\"alert alert-danger\">This should not be blank.</div>",
    required: "<div class=\"alert alert-danger\">This is required.</div>",
    pattern: "<div class=\"alert alert-danger\">This seems to be invalid.</div>",
    min: "<div class=\"alert alert-danger\">This should be greater than or equal to %s.</div>",
    max: "<div class=\"alert alert-danger\">This should be lower than or equal to %s.</div>",
    range: "<div class=\"alert alert-danger\">This should be between %s and %s.</div>",
    minlength: "<div class=\"alert alert-danger\">This is too short. It should have %s characters or more.</div>",
    maxlength: "<div class=\"alert alert-danger\">This is too long. It should have %s characters or fewer.</div>",
    length: "<div class=\"alert alert-danger\">This length is invalid. It should be between %s and %s characters long.</div>",
    mincheck: "<div class=\"alert alert-danger\">You must select at least %s choices.</div>",
    maxcheck: "<div class=\"alert alert-danger\">You must select %s choices or fewer.</div>",
    check: "<div class=\"alert alert-danger\">You must select between %s and %s choices.</div>",
    equalto: "<div class=\"alert alert-danger\">This should be the same.</div>"
  });
